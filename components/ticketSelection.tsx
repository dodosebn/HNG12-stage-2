  ...
  return (
    <LayoutCont>
      ...
      <main className="text-[#FAFAFA] bg-[#08252B] border-[1px] border-[#0E464F] p-3 rounded-3xl w-full mt-4">
        <div
          style={{
            background: "linear-gradient(to right, #08252B 5%, #02191D 95%)",
          }}
          className="bg-[#0A0C11] border-[1px] border-[#07373F] rounded-2xl text-gray-100 p-[2rem]"
        >
          <h1 className="text-6xl text-center topic">Techember Fest ’25</h1>
          <div className="Roboto">
            <p className="text-center mx-auto mt-2 w-[20rem]">
        ...
        <div>
          ...
          <div
            className="p-2 rounded-2xl border-[#07373F] border-[1px] bg-[#041E23] 
          flex gap-3"
          >
            <TickType
              price="Free"
        ...
        <div className="mt-4">
          ...
          <select
            name="number"
            className="w-full mt-2 rounded-lg p-[12px] outline-none bg-[#12464E] text-white"
